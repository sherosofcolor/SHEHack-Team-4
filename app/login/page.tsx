    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 md:p-12">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <Link href="/forgot-password" className="text-sm font-medium text-primary-600 hover:text-primary-800">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            ...
            <Link href="/signup" className="font-medium text-primary-600 hover:text-primary-800">
              Sign up
            </Link>
          </p>
        </div>
      ...
      <div className="hidden md:block md:flex-1 bg-primary-600 relative">
        ...
        <div className="absolute inset-0 flex flex-col justify-center p-12 text-white">
          <h2 className="text-3xl font-serif font-bold mb-4">Take control of your financial future</h2>
          <p className="text-primary-100 mb-8">
            Join thousands of women who are using Finova to build financial confidence and achieve their goals.
          </p>
